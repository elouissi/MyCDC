...
@section('content')
       ...
       @role('admin') 
       <span  class="text-muted fw-light" >Créer un CDC Mobile/</span>App e-commerce
       @endrole
    </h4>
            ...
            <hr >
                ...
                <div class="tab" id="tab-3">
                    ...
                    <div class="input-group">
                        ...
                        <textarea style="border-radius:20px" type="site" name="Site_internet_de_vos_principaux_concurrents" placeholder="Saisissez les sites internet de vos principaux concurrents"  ></textarea>
                        </div>
                        <div class="input-wrapper">
                ...
                <div class="tab" id="tab-4">
                    ...
                    <div class="input-group">
                        <div class="input-wrapper">
                        <table style="width: 550px; border: 1px solid #ddd;" class="table  mb-0 bg-white">
                        ...
                        <fieldset style="width: 604px;display: flex; flex-wrap: wrap; " >
                                    <div style="width:33%;display:block;line-height:8px">
                    ...
                    <div class="input-group">
                        <div class="input-wrapper">
                            ...
                            <textarea style="border-radius:20px; width:100%;height: 120px;" type="text" name="Palette_de_couleurs" placeholder="Indiquez les couleurs souhaitées pour votre site."   ></textarea>
                        </div>
                        <div class="input-wrapper">
                            <div class="aegov-form-control control-sm">
                                <label for="fileInput-sm">Télécharger des images </label>
                            ...
                            <select style="    height: 43px; border-radius: 11px;width:100%;" name="propositions" id="propositions">
                                <option value="" disabled selected  >Choisir le Nombre de propositions attendues </option>
